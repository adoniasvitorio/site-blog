...
featuredImage: /assets/amol-tyagi-0juktkotkpu-unsplash-1-.jpg
---
...
Aqui não vamos considerar casos onde falhas humanas ou de segurança tornaram este tipo de informação praticamente "publicas" a qualquer pessoas que tenha o interesse de consegui-las. Apenas aqueles onde pessoas mal intencionadas conseguem obter suas senhas e dados pessoais e, a partir dai fazem todo e qualquer tipo de maldade.
...
Comece criando senhas fortes ! Eu sei que isso parece obvio mas a maioria das pessoas utiliza senhas extremamente simples ou com pouca segurança. Um exemplo disso pode ser visto neste link com uma lista das [senhas mais utilizadas em 2020](https://en.wikipedia.org/wiki/List_of_the_most_common_passwords). \
...
* Evite numero e letras sequenciais.
* Não utilize o nome pessoas ou de seu pet.
* Todo tipo de datas deve ser descartada.
* As palavras “senha” e “password” devem ser evitada a todo custo.

**Não sei como criar senhas fortes ou não quero correr o risco!** \
...
\
Pra terminar vou deixar como sugestão a pagina [Dicas de Segurança](https://monitor.firefox.com/security-tips) do [Firefox Monitor](https://monitor.firefox.com/). Além de detalhar mais alguns dos itens que abordei também complementa com outras informações sobre esse universo.\
\
...
Créditos:\
\
Imagem: Photo by [Amol Tyagi](https://unsplash.com/@amoltyagi2?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/security?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).\
Conteúdo: [Firefox Monitor](https://monitor.firefox.com/) e [Wikipedia.org](https://en.wikipedia.org/wiki/Main_Page)